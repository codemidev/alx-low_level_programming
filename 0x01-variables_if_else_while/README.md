/* None empty readme
In this project, I have better understanding of arithmetic, logical, relational, and boolean operators in C. Additionally, I practiced declaring and defining variables of type char, int, and unsigned int, using if and if...else statements, and implementing while loops.

Tasks 0
0. Positive anything is better than negative noting
